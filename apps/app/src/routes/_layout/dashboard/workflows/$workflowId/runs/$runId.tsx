...
export const Route = createFileRoute("/_layout/dashboard/workflows/$workflowId/runs/$runId")({
  component: RunDetailsPage,
});

function RunDetailsPage() {
  const navigate = useNavigate({ from: Route.fullPath });
  const { workflowId, runId } = useParams({ from: "/_layout/dashboard/workflows/$workflowId/runs/$runId" });
